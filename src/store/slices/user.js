...
//     return async () => {
//              try{
//             const apiUrl = 'https://dummyjson.com/users?limit=3'; 
...
//     return async () => {
//         try {
//             const response = await axios.get('./populate.json');
//             dispatch(slice.actions.getUsersListStyle1Success(response.data.users_s1));
//         } catch (error) {
//             dispatch(slice.actions.hasError(error));
//         }
...
//       try {
//         const response = await fetch("populate.json");
//         if (response.ok) {
//           const data = await response.json();
//           dispatch(slice.actions.getUsersListStyle1Success(data.usersS1));
//         } else {
...
//         useEffect ( () => {
//             axios.get("seed/populate.json").then( (res) => {
